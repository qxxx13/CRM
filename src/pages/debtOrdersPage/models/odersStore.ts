...
export const fetchOrdersFx = createEffect<{ page: number; perPage: number; userId: string }, GetOrdersType>();

fetchOrdersFx.use((params) => fetchAllOrders(params.page, params.perPage, '', params.userId));
